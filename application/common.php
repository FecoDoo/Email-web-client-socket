...
function sendMail($to,$title,$content){
	...
	$mail->Username ='201619630324@zjut.edu.cn';

	//smtp登录的密码 使用生成的授权码（就刚才叫你保存的最新的授权码）
	$mail->Password = 'eset@050505';

	//设置发件人邮箱地址 这里填入上述提到的“发件人邮箱”
	$mail->From = '201619630324@zjut.edu.cn';
...
function receiveMail($host,$user,$pwd)
{
	$dmail = new Pop($host, $user, $pwd);
	$msg = $dmail->pop3();
	$ret = $msg;
	$mail_list = '';
	$list = array();
